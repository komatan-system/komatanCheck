...
function getStudentIDFromSS2() {

  // 入力された生徒名を取得
  const studentName = INPUT2_SHEET.getRange("A2").getValue().toString().trim();
...
function getTeachcerIDFromSS2(){

  // 入力された講師名を取得
  const teacherName = INPUT2_SHEET.getRange("B2").getValue().toString().trim();
